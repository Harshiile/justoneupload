...
import { JOUError } from '../server/src/lib/error';
import { db } from '../server/src/db';
import { and, eq, getTableColumns } from 'drizzle-orm';
import { VideoTable, VideoWorkspaceJoinTable, WorkspaceTable } from '../server/src/db/schema';
import { drive, oauth2Client } from '../server/src/lib/secrets';
import { google } from 'googleapis';
import { SendNotifyMail, VideoNofityMail } from '../server/src/controllers/mail/templates/notify';
