    ...
    <div className="bg-black text-white min-h-screen font-sans overflow-x-hidde relative w-full">
      ...
      >
        ...
        <p className="text-lg md:text-2xl max-w-xl">
          Revolutionizing content delivery for YouTubers & Editors with a
          seamless, one-click upload platform.
        </p>
        <Link href={"/login"}>
          <motion.button
      ...
      {screenshots.map((shot, i) => {
        ...
        return (
          ...
          >
            <div
              className={`flex flex-col md:flex-row items-center justify-center max-w-[1200px] mx-auto ${
      ...
      <footer className="text-center text-gray-500 pt-8 flex flex-col items-center gap-y-3">
        ...
        <Image src="/logo.png" alt="JOU LOGO" width={100} height={100} />
      </footer>
    </div>
  );
}
