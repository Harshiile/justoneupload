...
const Upload = () => {
  ...
  const [chosenWs, setChosenWs] = useState<Workspace | null>(null);
  const [workspacesForChooseWS, setWorkspacesForChooseWS] = useState<
  ...
  useEffect(() => {
    AsyncFetcher({
      ...
      cb: ({ workspaces }: { workspaces: Record<string, Workspace> }) => {
        setWorkspacesForChooseWS(
          Array.from(new Map(Object.entries(workspaces)))
        );
      },
    });
    socket.connect();
  ...
  const convertDurationIntoYTTimeFormat = (seconds: number): string => {
  ...
  return (
    <motion.div
      ...
      className={`w-full h-full bg-primary text-[#e3e3e3] shadow-xl flex flex-col overflow-y-auto ${
        user?.userType != "youtuber" && "px-4 md:px-8"
      }`}
    >
      {user?.userType === "youtuber" ? (
        ...
        <ChooseWS
          setChosenWs={setChosenWs}
          workspacesForChooseWS={workspacesForChooseWS}
        />
      ) : (
        <>
          {/* Heading */}
          <div className="flex flex-col sm:flex-row justify-center items-center mb-6 gap-4 text-center">
            <motion.p
              ...
              className="text-xl sm:text-2xl font-semibold tracking-tight select-none"
            >
              Upload Video on
            </motion.p>
            <div className="flex gap-3 items-center">
              <img src={chosenWs.avatar} className="w-10 h-10 rounded-full" />
              <p className="text-sm sm:text-base">{chosenWs.userHandle}</p>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <ScrollArea className="flex-1 w-full">
              ...
              >
                ...
                >
                  ...
                  <div>
                    <Label htmlFor="desc" className="text-md mb-2">
                      Description
                    </Label>
                    <Textarea
                      id="desc"
                  ...
                  {isSchedule && (
                    <div>
                      <Label htmlFor="schedule" className="text-md mb-2">
                        Schedule
                      </Label>
                  ...
                  <div>
                    <Label htmlFor="videoType" className="text-md mb-2">
                      Video Type
                    </Label>
                  ...
                  <div>
                    <Label htmlFor="isMadeForKids" className="text-md mb-2">
                      Audience
                    </Label>
                    <RadioGroup id="isMadeForKids" className="ml-3">
                      <div className="flex gap-x-3">
                        ...
                        />
                        <Label htmlFor="notMadeForKids" className="select-none">
                      ...
                      <div className="flex gap-x-3">
                        ...
                        />
                        <Label htmlFor="madeForKids" className="select-none">
                          Yes, Made For Kids
                        </Label>
                      </div>
                    </RadioGroup>
                  ...
                  {isThumbnail && (
                    <div>
                      <Label htmlFor="thumbnail" className="text-md mb-2">
                        Thumbnail
                      </Label>
                      <input
                        hidden
                      ...
                      <AnimatePresence>
                        {!thumbnailPreviewUrl ? (
                          ...
                          >
                            ...
                            <p className="text-md text-[#d4d4d8]">
                ...
                <input
                  type="submit"
                  value="Upload"
                  className="hidden sm:block w-full bg-white text-black px-2 py-2 rounded-md font-semibold hover:bg-gray-200 transition"
                />
                <UploaderDrawer
            ...
            {/* Vertical Separator for lg+ only */}
            <Separator
              orientation="vertical"
              className="hidden lg:block mx-6 bg-secondary w-[2px]"
            />

            {/* Video Preview Section */}
            <div className="flex-1 w-full">
              <div>
                <Label htmlFor="file" className="text-md mb-2">
                  Video
                </Label>
                <input
                  hidden
                  ...
                  {!videoPreviewUrl ? (
                    ...
                    <motion.video
                      ...
                      onLoadedData={(e: SyntheticEvent<HTMLVideoElement>) =>
                        setDuration(
                          convertDurationIntoYTTimeFormat(
                ...
                <input
                  type="submit"
                  value="Upload"
                  className="block sm:hidden w-full bg-white text-black px-2 py-2 rounded-md mt-6 font-semibold hover:bg-gray-200 transition"
                />
              </div>
            </div>
          </div>
