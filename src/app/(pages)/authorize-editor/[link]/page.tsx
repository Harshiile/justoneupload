    ...
    >
      ...
      >
        ...
        <div className="px-4 sm:px-6 md:px-12 lg:px-24 xl:px-32 pt-20 pb-8 text-center text-dull">
          ...
          >
            <h2 className="text-lg sm:text-xl font-semibold text-dull mb-3">
              Authorize Editor
            </h2>
            ...
            <span className="text-sm sm:text-base">
              {" "}
              has requested permission to join your workspace{" "}
              <strong>{data.wsName}</strong>
            </span>
          </motion.div>
          ...
          >
            <p className="mb-2">
              Once you <strong>authorize</strong>{" "}
              <span className="text-white">{data.editorName}</span>, they will
              be granted access to your workspace
            </p>
            <p className="mb-2">
              Editors can <strong>upload & schedule videos</strong> directly to
              your YouTube channel
            </p>
            <p className="mb-2">
              You’ll receive notifications when a video is ready, and you can{" "}
              <strong>review & approve it</strong> before it goes live
            </p>
            <p className="text-red-400 mt-2">
              If you decline this request, the editor will not be able to access
              your workspace
            </p>
          </motion.div>
