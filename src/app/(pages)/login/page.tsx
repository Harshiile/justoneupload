...
const CheckMessage = ({ condition, message }: props) => (
  ...
  return (
    ...
    >
      <div className="w-full flex flex-col gap-y-6">
        ...
        >
          <Label htmlFor="email" className="text-base sm:text-md">
            Email
          </Label>
          <Input
            id="email"
        ...
        <AnimatePresence>
          {!isLogin && (
            ...
            >
              <Label htmlFor="name" className="text-base sm:text-md">
                Name
              </Label>
              <Input
                id="name"
        ...
        <motion.div
          ...
          className="flex flex-col items-start gap-y-2"
        >
          <Label htmlFor="password" className="text-base sm:text-md">
            Password
          </Label>
          <Input
            id="password"
            ...
            >
              ...
              <Select onValueChange={(value) => setRole(value)}>
                ...
                <SelectContent className="bg-[#09090b] text-[#e3e3e3]">
                  <SelectItem value="youtuber" className="hover:font-bold">
                    Youtuber
                  </SelectItem>
                  <SelectItem value="editor" className="hover:font-bold">
                    Editor
                  </SelectItem>
                </SelectContent>
              </Select>
